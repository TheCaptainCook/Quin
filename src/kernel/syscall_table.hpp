...
constexpr uint64_t SYS_link            = 9;
constexpr uint64_t SYS_unlink          = 10;
constexpr uint64_t SYS_getpid          = 20;
constexpr uint64_t SYS_getuid          = 24;
constexpr uint64_t SYS_geteuid         = 25;
constexpr uint64_t SYS_getgid          = 47;
constexpr uint64_t SYS_getegid         = 43;
constexpr uint64_t SYS_ioctl           = 54;
constexpr uint64_t SYS_readv           = 120;
constexpr uint64_t SYS_writev          = 121;
constexpr uint64_t SYS_lseek           = 199;
...
constexpr uint64_t SYS_sigaction       = 416;
constexpr uint64_t SYS_sigprocmask     = 340;
